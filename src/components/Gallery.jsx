    ...
    <section id="gallery">
      <div className="container">
        ...
        <div className="row" ref={gridRef}>
          <div className="col-sm-6 col-md-4 grid-item category-a p-1">
            <div className="overflow-hidden rounded des">
              <img
                className=""
                src="https://upload.wikimedia.org/wikipedia/commons/d/dd/Schwarzes_Nashorn-01.jpg"
                alt="Rhinoceros"
              />
            </div>
          </div>
          <div className="col-sm-6 col-md-4 grid-item category-b p-1">
            <div className="overflow-hidden rounded des">
              <img
                className=""
                src="https://t2.ea.ltmcdn.com/pt/posts/3/9/2/caracteristicas_dos_elefantes_23293_0_600.jpg"
                alt="Elephant"
              />
            </div>
          </div>
